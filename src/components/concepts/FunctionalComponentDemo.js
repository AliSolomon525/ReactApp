//component file names must be capitalized, all separate words have capital letters
      ...
      <Row>
        <Col xs="12">
          ...
          <dl>
            ...
            <dd>
              With the "useEffect" hook, functinal components can perform side
              effects with any props ore state changes.
            </dd>
            <dt>return()</dt>
            <dd>
...
//Fat Arrow Functional Component
