    ...
    return(
        <div className="main">
            <div className="mainDiv">
                ...
                <p>Below are some of the resources that we used throughout this app. You'll have one challenge where you'll be asked to make this page better.</p>
                <ul>
                    <li>The Official Docs</li>
                    <li>React Router Dom</li>
                    <li>Stephen Grider's Udemy Course for Udemy API.</li>
                    ...
                    <li>https://www.heptunion.github.io/react-photo-gallery-examples.basic.html</li>
